...
# 41 "/usr/include/c++/11/string_view" 2 3
...
# 42 "/usr/include/c++/11/string_view" 2 3
...
# 44 "/usr/include/c++/11/string_view" 2 3
...
# 45 "/usr/include/c++/11/string_view" 2 3
...
# 40 "/usr/include/c++/11/stdexcept" 2 3
...
enum class WasmSection { CUSTOM_SECTION, TYPE_SECTION, IMPORT_SECTION, FUNCTION_SECTION, TABLE_SECTION, MEMORY_SECTION, GLOBAL_SECTION, EXPORT_SECTION, START_SECTION, ELEMENT_SECTION, CODE_SECTION, DATA_SECTION }; inline std::string_view toString(WasmSection value) { switch (value) { case WasmSection:: CUSTOM_SECTION, TYPE_SECTION, IMPORT_SECTION, FUNCTION_SECTION, TABLE_SECTION, MEMORY_SECTION, GLOBAL_SECTION, EXPORT_SECTION, START_SECTION, ELEMENT_SECTION, CODE_SECTION, DATA_SECTION : return "CUSTOM_SECTION, TYPE_SECTION, IMPORT_SECTION, FUNCTION_SECTION, TABLE_SECTION, MEMORY_SECTION, GLOBAL_SECTION, EXPORT_SECTION, START_SECTION, ELEMENT_SECTION, CODE_SECTION, DATA_SECTION"; default: return "Unknown"; } }
# 40 "parser.hpp"
                                        ;
# 3 "parser.cpp" 2
...
# 22 "parser.cpp"
   "shift < sizeof(T) * 8"
# 22 "parser.cpp" 3 4
   , "parser.cpp", 22, __extension__ __PRETTY_FUNCTION__))
# 22 "parser.cpp"
                                ;
...
# 36 "parser.cpp"
 "pos <= size"
# 36 "parser.cpp" 3 4
 , "parser.cpp", 36, __extension__ __PRETTY_FUNCTION__))
# 36 "parser.cpp"
                    ;
